 ...
 *
 * this is almost a copy of algs4 website code. "http://algs4.cs.princeton.edu/13stacks/Evaluate.java.html"
 *
 */
    ...
    public static void main(String[] args)
    {
        ...
        while(!StdIn.isEmpty())
        {
            ...
            else if (s.equals(")"))
            {
                ...
                else if (op.equals("/")) v = vals.pop()/v;  // what if v == 0 ???
